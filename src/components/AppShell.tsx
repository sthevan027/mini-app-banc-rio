  ...
  return (
    <main className="min-h-screen px-4 py-6 text-slate-100 sm:px-6 lg:px-10">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6">
        <header className="overflow-hidden rounded-[32px] border border-white/10 bg-slate-950/50 shadow-2xl backdrop-blur">
          <div className="flex flex-col gap-6 px-6 py-6 sm:px-8 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm text-slate-300 sm:text-base">
                Sessão mockada para {user?.name}. A aplicação separa
                autenticação, camada de API, estado global e validação de
                formulário.
              </p>
            </div>
